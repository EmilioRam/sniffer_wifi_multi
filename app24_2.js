...
const snifferId = 'sniffer2.4Ghz_2(ch8-13)'; //cambiar por id del sniffer en el que se ejecute
...
function init() {
    ...
    var pcapSession = pcap.createSession('wlan0', { filter: 'type mgt subtype probe-req' });
